...
# 使用我们自定义的数据集
elif args.dataset == 'expressway':
    datasets,vocabs,embeddings = load_traffic_ner(expressway_ner_path,yangjie_rich_pretrain_unigram_path,
                                                           yangjie_rich_pretrain_bigram_path,
                                                           _refresh=refresh_data,index_token=False,train_clip=args.train_clip,
                                                           _cache_fp=raw_dataset_cache_name,
                                                           char_min_freq=args.char_min_freq,
...
cache_name = os.path.join('cache',args.dataset)
